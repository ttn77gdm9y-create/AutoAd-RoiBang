...
def settings_readiness(request: Request) -> dict:
    ...
    rows = [
        ...
        },
        {
            ...
            "状态": "ready",
            "说明": "高风险动作均走中文预览、确认执行、任务中心和操作日志。",
        },
        {
            "验收项": "任务中心可查看执行状态、stdout、stderr、结果 artifact",
            "状态": "ready",
            "说明": "任务详情抽屉展示中文摘要、标准输出、标准错误和结果文件。",
        },
        {
            "验收项": "操作日志可追溯前端动作",
            "状态": "ready",
            "说明": "操作日志支持任务 ID 过滤，并展示状态、触发人、结果文件和报告文件。",
        },
        {
        ...
        },
        {
            ...
            "状态": "ready",
            "说明": "真实业务动作由固定脚本启动，并写入任务 artifact 与 operation log。",
        },
    ]
