...
<https://api.oceanengine.com/open_api/v3.0/project/delete/>
[可视化调试](https://open.oceanengine.com/tools/visual_debug.html?docId=1740944781036608)
...
| project\_ids | number[] | 项目ID集合，且每一个营销项目ID属于客户ID，list长度限制1～10 |
...
| data | json | json返回值 |
| project\_ids | number[] | 删除成功的营销项目ID集合 |
| errors | object[] | 删除失败的营销项目列表 |
| project\_id | number | 项目列表 |
