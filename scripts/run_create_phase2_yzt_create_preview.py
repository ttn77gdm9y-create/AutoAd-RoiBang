...
from roibang_v2.workflows.create_phase2_yzt_create_preview import (
    run_create_phase2_yzt_create_preview_request,
)


def run_from_args(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Phase 2 勇者突进 create preview.")
    ...
    if config.external_api_enabled or config.execution_enabled:
        raise RuntimeError("勇者突进创建预览要求 external_api_enabled=false 且 execution_enabled=false")
