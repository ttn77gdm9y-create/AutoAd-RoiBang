...
from roibang_v2.workflows.create_live_execute_runner import run_create_live_execute_runner_request
...
def run_from_args(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build blocked live create runner review artifact.")
    ...
    if config.external_api_enabled or config.execution_enabled:
        raise RuntimeError("create live execute runner CLI requires external_api_enabled=false and execution_enabled=false")
        ...
        json.dumps(
            {
                ...
                "runner_gate": result["runner_gate"],
