...
def run_from_args(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Phase 1 create preflight checks.")
    ...
    if config.external_api_enabled or config.execution_enabled:
        raise RuntimeError("Phase 1 create preflight requires external_api_enabled=false and execution_enabled=false")
