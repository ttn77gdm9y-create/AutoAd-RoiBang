    ...
    assert calls == [
        {
            ...
            "metrics": "[\"stat_cost\",\"show_cnt\",\"click_cnt\",\"convert_cnt\",\"active_register\",\"attribution_convert_cnt\",\"attribution_convert_cost\",\"attribution_billing_game_in_app_ltv_1day\",\"attribution_billing_game_in_app_roi_1day\"]",
            "filters": "[]",
